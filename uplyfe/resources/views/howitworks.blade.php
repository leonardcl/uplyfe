...
<head>
    ...
    <title>How It Works - Uplyfe</title>
            ...
            <div class="flex-1 overflow-y-auto p-6 md:p-8">
                <div class="max-w-5xl mx-auto space-y-8">
                    ...
                    <section class="text-center py-8">
                        <h2 class="text-3xl md:text-4xl font-heading font-bold mb-4">Your Health Journey in 4 Simple
                            Steps</h2>
                        <p class="text-muted-foreground text-lg max-w-2xl mx-auto">
                            Uplyfe makes it easy to take control of your health with AI-powered insights tailored to
                            your unique needs.
                        </p>
                    </section>
                    ...
                    <section class="space-y-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            <div
                                class="flex-shrink-0 w-16 h-16 rounded-2xl bg-primary flex items-center justify-center text-primary-foreground shadow-md">
                                <span class="text-2xl font-bold">1</span>
                            </div>
                            <div class="flex-1 bg-card rounded-2xl p-6 border border-border shadow-sm">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-bold">Upload Your Medical Reports</h3>
                                </div>
                                <p class="text-sm text-muted-foreground">
                                    Start by uploading your blood work, health checkup reports, or any medical
                                    documents. Our secure system accepts PDF, JPG, and PNG files up to 10MB. Your data
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div class="flex-1 bg-card rounded-2xl p-6 border border-border shadow-sm">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-bold">AI Analyzes Your Data</h3>
                                </div>
                                <p class="text-sm text-muted-foreground">
                                    Our advanced AI engine processes your medical reports, translating complex medical
                                    terminology into easy-to-understand insights. It identifies key health metrics and
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div class="flex-1 bg-card rounded-2xl p-6 border border-border shadow-sm">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-bold">Get Personalized Recommendations</h3>
                                </div>
                                <p class="text-sm text-muted-foreground">
                                    Based on your health profile, Uplyfe generates customized nutrition plans, exercise
                                    routines, and daily habits. All recommendations are tailored to your specific health
                                    needs and goals.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div class="flex-1 bg-card rounded-2xl p-6 border border-border shadow-sm">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 class="text-lg font-bold">Track & Improve Over Time</h3>
                                </div>
                                <p class="text-sm text-muted-foreground">
                                    Monitor your health score, track progress, and adjust your goals. Regular uploads of
                                    new reports allow the AI to update recommendations and help you see improvements
                                    over time.
                                </p>
                            </div>
                        </div>
                    ...
                    <section class="bg-card rounded-3xl border border-border p-8 shadow-sm">
                        <h2 class="text-2xl font-heading font-bold mb-6 text-center">Why Choose Uplyfe?</h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex items-start gap-4">
                                <div
                                    class="w-10 h-10 rounded-lg bg-tertiary/20 flex items-center justify-center text-tertiary flex-shrink-0">
                                    <iconify-icon icon="lucide:shield-check" class="text-xl"></iconify-icon>
                                </div>
                                <div>
                                    <h4 class="font-bold mb-1">Privacy First</h4>
                                    <p class="text-sm text-muted-foreground">Your health data is encrypted and never
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1">Save Time</h4>
                                    <p class="text-sm text-muted-foreground">Get instant insights instead of waiting for
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1">Personalized Goals</h4>
                                    <p class="text-sm text-muted-foreground">Recommendations tailored to your unique
                                        health profile.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold mb-1">24/7 AI Support</h4>
                                    <p class="text-sm text-muted-foreground">Get answers to your health questions
                                        anytime, anywhere.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section
                        ...
                        <h2 class="text-2xl md:text-3xl font-heading font-bold mb-4">Ready to Get Started?</h2>
